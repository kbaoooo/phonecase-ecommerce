          ...
          <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
            ...
            <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
              <div className="flex -space-x-4">
                ...
                <img src="/users/user-5.jpg" alt="" className="inline-block w-10 h-10 rounded-full ring-2 ring-slate-100"/>
              </div>
            </div>
      ...
      <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
          ...
          <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
            ...
            <div className="flex gap-4 mt-2">
              ...
              <div className="flex flex-col">
                <p className="font-semibold">Phuong Nhi</p>
          ...
          <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
            ...
            <div className="text-lg leading-8">
              <p>
                &quot;I usually keep my phone together with my keys in my poket and that led to some pretty heavy scratchmarks on all of my last cases. This one, besides a barely noticeable scratch on the corner,
                <span className="p-0.5 bg-slate-800 text-white">looks brand new after about half a year</span>. It dig it.&quot;
              </p>
            </div>
            ...
            <div className="flex gap-4 mt-2">
              ...
              <div className="flex flex-col">
                <p className="font-semibold">Lam Vu</p>
                <div className="flex gap-1.5 items-center text-zinc-600">
                  <Check className="h-4 w-4 stroke-[3px] text-green-600"/>
                  <p className="text-sm">Verified Purchase</p>
                </div>
      ...
      > 
        ...
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          ...
          >
            ...
            <div className="ralative h-80 md:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
        ...
        <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
          ...
          <li className="w-fit">
            <Check className="h-5 w-5 text-green-600 inline mr-1.5"/>
            Scratch- and gingerprint resistant coating
          </li>
          <li className="w-fit">
            <Check className="h-5 w-5 text-green-600 inline mr-1.5"/>
